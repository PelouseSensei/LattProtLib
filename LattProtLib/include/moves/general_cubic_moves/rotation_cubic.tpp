...
void RotationCubic::checkMove(Configuration<CubicLattice>& config) {
...
bool RotationCubic::apply(Configuration<CubicLattice>& config) {
...
void RotationCubic::generateMoveArgs(Configuration<CubicLattice>& config) {
    ...
    // Pick rotation axis
    moveArgs.rotation_axis = static_cast<RotationAxis>(dist_axis(this->rng));

    // Pick rotation angle (multiples of 90°)
    ...
    for (int i = 0; i < moveArgs.b_length; ++i) {
        ...
        int z = curr[2] - moveArgs.rotation_center[2];

        Position r;

        // Apply rotation depending on axis
        switch (moveArgs.rotation_axis) {
            case RotationAxis::X:
                switch (moveArgs.rotation_angle % 360) {
                    case 90:  r = { x, -z,  y }; break;
                    case 180: r = { x, -y, -z }; break;
                    case 270: r = { x,  z, -y }; break;
                    default:  r = { x,  y,  z }; break;
                }
                break;

            case RotationAxis::Y:
                switch (moveArgs.rotation_angle % 360) {
                    case 90:  r = {  z, y, -x }; break;
                    case 180: r = { -x, y, -z }; break;
                    case 270: r = { -z, y,  x }; break;
                    default:  r = {  x, y,  z }; break;
                }
                break;
            ...
            case RotationAxis::Z:
                switch (moveArgs.rotation_angle % 360) {
                    case 90:  r = { -y,  x, z }; break;
                    case 180: r = { -x, -y, z }; break;
                    case 270: r = {  y, -x, z }; break;
                    default:  r = {  x,  y, z }; break;
                }
                break;
        }
        ...
        r[2] += moveArgs.rotation_center[2];
